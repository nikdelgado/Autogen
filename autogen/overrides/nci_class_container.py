...
#         """
#         Difference from xsdata is that restrictions are kept when converting to an alias, which is required for UCI.
#         """
...
# class NciClassContainer(ClassContainer):
...
#     like UUID that we replace in UCI.
#     """
